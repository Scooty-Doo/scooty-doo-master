...
def test_setup_frontend(mock_frontend_run, mock_frontend_setup):
    """Test the setup frontend method."""
...
def test_setup_bike_no_bikes():
    """Test the setup bike method with no bikes."""
